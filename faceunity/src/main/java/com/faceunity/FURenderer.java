...
public class FURenderer implements OnFUControlListener {
    ...
    private static float mFilterLevel = 0.8f;//滤镜强度
    private static float mBlurLevel = 0.7f;//磨皮程度
    private static float mBlurType = 2.0f;//磨皮类型：精细磨皮
    private static float mColorLevel = 0.8f;//美白
    private static float mSharpen = 0.8f;//锐化
    private static float mRedLevel = 0.8f;//红润
    ...
    public static void initFURenderer(Context context) {
        ...
        int setup = faceunity.fuSetup(new byte[0], authpack.A());
        ...
        sIsInited = isInited;
        Log.i(TAG, "initFURenderer finish. isLibraryInit: " + isInited + ",setup=" + setup);
    }
